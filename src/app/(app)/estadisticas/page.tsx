...
export default async function Page({
  ...
  const [datosMensuales, estadisticasOperativas] = await Promise.all([
    getCobradosMensuales(anioSeleccionado),
    getEstadisticasOperativas(anioSeleccionado),
  ]);
