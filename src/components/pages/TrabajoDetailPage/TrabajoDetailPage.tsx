        ...
        <aside className={cn("TrabajoDetailPageSidebar", styles.TrabajoDetailPageSidebar)}>
          ...
          <Card as="section" className="space-y-3">
            ...
            <PdfShareButton
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl border border-[var(--color-danger-border)] bg-[var(--color-danger-bg)] px-4 py-2.5 text-sm font-semibold text-[var(--color-danger-text)] transition hover:bg-[var(--color-danger-bg-strong)]"
            >
              Descargar PDF
            </PdfShareButton>
            <Divider />
