...
export function ErrorState({
  ...
  return (
    <div className="relative isolate flex min-h-screen items-center justify-center overflow-hidden px-5 py-10 sm:px-8">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgb(var(--brand-500-rgb)_/_0.16),transparent_28%),radial-gradient(circle_at_bottom_right,rgb(var(--brand-400-rgb)_/_0.18),transparent_34%)]" />
      ...
      <Card className="relative z-10 w-full max-w-3xl overflow-hidden border-white/60 bg-[var(--color-surface-raised)]/90 p-0 shadow-[0_32px_100px_var(--color-shadow-lg)] backdrop-blur">
          ...
          <aside className="flex flex-col justify-between bg-[linear-gradient(180deg,var(--color-surface-alt),var(--color-surface-raised))] px-6 py-8 sm:px-8 sm:py-10">
            <div>
              ...
              <ul className="mt-5 space-y-4 text-sm leading-6 text-[var(--text-color-gray)] sm:text-base">
                <li className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-raised)]/70 px-4 py-3">
